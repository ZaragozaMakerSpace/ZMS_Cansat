...
void eepromGet()
{
  ...
  for (uint8_t i = 0; i < 1024 / sizeof(miniPaquete); i++)
  {
    ...
    s += String (i) +":" + String (miniPaquete.idPaquete) + "," + String(miniPaquete.altitud) + "," + String(miniPaquete.temperatura) + "," + String (miniPaquete.acMaxima) + "," + String (miniPaquete.acMinima);
    Serial.println(s);
    s = "";
  }
}
